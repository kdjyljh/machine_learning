...
% num_iters1 = 4000;
% theta = zeros(3, 1);
% [theta, J_history1] = gradientDescentMulti(X, y, theta, alpha1, num_iters1);
...
predic_x1 = [1 (1650 - mu(1))/sigma(1) (3 - mu(2))/sigma(2)];
price = predic_x1*theta; % You should change this
...
% ====================== YOUR CODE HERE ======================
predic_x2 = [1 1650 3];
price = predic_x2*theta; % You should change this
